  ...
  return (
    <div style={wrap}>
      ...
      <div style={shell}>
        ...
        {/* ---------------- FOOTER ---------------- */}
        <a href="https://github.com/Sibbern/sejl-quiz" target="_blank" rel="noopener noreferrer"
          style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 18, color: C.steel, opacity: 0.65, textDecoration: "none", fontSize: 13, fontWeight: 600 }}>
